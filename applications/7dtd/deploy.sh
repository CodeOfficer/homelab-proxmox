...
echo "  Game Server: 10.20.11.210:26900"
echo "  Web Admin:   http://10.20.11.210:8080"
echo "  Telnet:      10.20.11.210:8081"
echo ""
echo "First startup downloads ~12GB via Steam."
echo "This takes 30-45 minutes. Check progress with:"
echo ""
echo "  kubectl logs -n 7dtd -l app.kubernetes.io/name=7dtd -f"
echo ""
